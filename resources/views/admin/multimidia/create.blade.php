        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{url('/multimidia/store')}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="file" name="image[]" multiple="multiple" class="form-control" id="inputEmail4" placeholder="" required>
                                    </div>
