        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="row gutters">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{url('/projeto/update')}}/{{$dados->id}}" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="text" value="{{$dados->author}}" name="author" class="form-control" id="inputEmail4" placeholder="">
                                    </div>
                                    <div class="form-group col-md-4">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="description" id="summernote01" rows="10" required>{{$dados->description}}</textarea>
                                    </div>
